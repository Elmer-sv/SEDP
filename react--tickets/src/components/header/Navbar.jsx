...
const navigation = [
  ...
  { name: 'Tickets', to: '/misTickets', current: false },
  { name: 'Escaner', to: '/scannerQR', current: false },
  { name: 'Grafica', to: '/grafica', current: false },
]
...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-nav-color">
      {({ open }) => (
        <>
